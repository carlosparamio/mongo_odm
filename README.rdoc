...
In a near future, you will be able to define each find on a separated class method, and concatenate them by using those method calls (like 'with_radius(n).ordered_by_color').
